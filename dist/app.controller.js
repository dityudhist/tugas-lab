...
let AppController = class AppController {
    ...
    async searchMahasiswa(nim, nama, jurusan) {
...
__decorate([
    (0, common_1.Get)('pencarian/mahasiswa'),
    (0, swagger_1.ApiQuery)({ name: 'nim', required: false }),
    (0, swagger_1.ApiQuery)({ name: 'nama', required: false }),
    (0, swagger_1.ApiQuery)({ name: 'jurusan', required: false }),
    __param(0, (0, common_1.Query)('nim')),
    __param(1, (0, common_1.Query)('nama')),
    __param(2, (0, common_1.Query)('jurusan')),
    __metadata("design:type", Function),
